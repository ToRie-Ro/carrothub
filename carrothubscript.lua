...
v23.Draggable = true;
v23.Image = "rbxassetid://109941566378419";
v24.Parent = v23;
...
v23.MouseButton1Down:Connect(function()
    ...
    v47:Play();
    game:GetService("VirtualInputManager"):SendKeyEvent(true, Enum.KeyCode.LeftControl, true, Enum.KeyCode.LeftControl, , game);
...
local v56 = v16.Main:AddSection("Mobs Near in This Island");
...
local v56 = v16.Shop:AddSection("Abilities Shop");
v16.Shop:AddButton({
    Title = "Geppo",
    Description = "",
    Callback = function()
...
local v56 = v16.Shop:AddSection("Fighting Style");
v16.Shop:AddButton({
    Title = "Black Leg",
    Description = "",
    Callback = function()
