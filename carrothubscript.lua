...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://119854371649802",
...
--     end
-- end);
local Checking = loadstring(game:HttpGet("https://raw.githubusercontent.com/ToRie-Ro/Zezerscript/refs/heads/main/Checking.lua"))()
local Notify = loadstring(game:HttpGet("https://raw.githubusercontent.com/ToRie-Ro/Zezerscript/refs/heads/main/ZeZerHubNotify.lua"))()
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=119854371649802";
v24.Parent = v23;
...
v16.Home:AddButton({
    Title = "Discord",
    Description = "By Lunar",
    Callback = function()
        setclipboard("https://discord.gg/n7bp8epE");
    end
});
...
local v52 = v16.Main:AddToggle("ToggleHakiFortress", {
    Title = "Auto Haki Color Fortress",
    Description = "",
    Default = false
});
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("You: " .. tostring(v768) .. " Bones");
            end
        end);
    end);
...
if Sea3 then
    local v498 = v16.Sea:AddSection("KitsuneIsland");
...
if Sea3 then
    ...
    v505.RenderStepped:Connect(function()
        ...
        if v594 then
            ...
            if not v513 then
                v14:Notify({
                    Title = "...",
                    Content = "PrehistoricIsland Spawned",
                    Duration = 10
                });
                v513 = true;
            end
    ...
    local v515 = v16.Sea:AddToggle("AutoFindFrozen", {
        Title = "Auto Find FrozenDimension",
        Description = "",
        Default = false
    });
    ...
    local v516 = v16.Sea:AddToggle("AutoComeTiki", {
        Title = "Auto Tiki",
        Description = "You need Leviathan Health to go Tiki",
        Default = false
    });
    ...
    local v517 = v16.Sea:AddToggle("AutoComeHydra", {
        Title = "Auto Hydra",
        Description = "You need Leviathan Health to go Hydra",
        Default = false
    });
...
local v93 = v16.Setting:AddSection("Use Skill");
...
local v119 = v16.Teleport:AddToggle("ToggleAutoSea2", {
    Title = "Auto ho to Sea 2",
    Description = "In Level 700",
    Default = false
});
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    Title = "Fruit Raid",
    Description = "Chose the fruit UnCommon",
    Default = false
});
...
local v56 = v16.Shop:AddSection("Shop");
v16.Shop:AddButton({
    Title = "Geppo",
    Description = "",
    Callback = function()
...
v16.Misc:AddButton({
    Title = "Join the game server change again",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Change Team");
v16.Misc:AddButton({
    Title = "Pirates",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Random Code");
local v150 = {
    "KITT_RESET",
    "Sub2UncleKizaru",
...
local v56 = v16.Misc:AddSection("Awaking");
v16.Misc:AddButton({
    Title = "Awaking",
    Description = "",
    Callback = function()
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    Title = "Auto Fine Frozen Dimension",
    Description = "",
    Default = false
});
...
local v160 = v16.Sea:AddToggle("ToggleHydraTree", {
    Title = "Auto Destroy Tree",
    Description = "Destroy Tree in Dojo",
    Default = false
});
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Auto Go Door Trial Draco",
    Description = "",
    Default = false
});
    ...
    pcall(function()
        while wait() do
            if ggame:GetService("Workspace").Map:FindFirstChild("PrehistoricIsland") then
                v169:SetDesc("Prehistoric Island Spawned: ✅️");
            else
                v169:SetDesc("Prehistoric Island not Spawned: ❌️");
            end
        end
    end);
end);
local v170 = v16.Sea:AddToggle("ToggleTPVolcano", {
    Title = "Auto Fine Prehistoric Island",
    Description = "You need to have Volcano Manet",
    Default = false
});
